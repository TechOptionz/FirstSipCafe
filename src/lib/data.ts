...
const MENU: RawCategory[] = [
  ['hot', 'Hot Coffees', 'Hot · 8 oz', [['Espresso', 10], ['Americano', 10], ['Cappuccino', 18], ['Spanish Latte', 20], ['Flat White', 18], ['Caffe Latte', 18], ['Caramel Latte', 20], ['Cafe Mocha', 20], ['Popcorn Latte', 18]]],
  ['iced', 'Iced Coffees', 'Iced · 16 oz', [['Iced V60', 22], ['Iced', 15], ['Iced Spanish Latte', 20], ['Iced Espresso', 14], ['Iced Latte', 20], ['Iced Cappuccino', 18]]],
  ['small', 'Small Coffees', 'Hot · 4 oz', [['Spanish Cortado', 18], ['Cortado', 15], ['Piccolo', 15], ['Macchiato', 15]]],
  ['noncoffee', 'Non Coffees', 'Hot or iced', [['Hot Chocolate', 18], ['Pistachio', 22], ['Water', 2]]],
...
const CAT_DESC: Record<string, string> = {
  ...
  small: 'A short, concentrated cup for those who like their coffee strong and their milk minimal.',
  noncoffee: 'Rich, comforting and caffeine-light. A favourite with families and first-time visitors.',
...
export const FEATURE_BLURBS: Record<string, string> = {
  hot: 'Nine ways to start the day, from a straight double espresso to our signature Spanish Latte.',
